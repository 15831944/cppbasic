...
struct bankUser
{
	...
	CString m_sName;   //姓名
	CString m_sSex;   //性别  
	unsigned long long int m_sBalance;    //余额(无上限)
	CString m_sID_number;   //身份证号码
	CString m_sCompany;   //单位
	unsigned long long int m_uTelphone;  //电话号码
	CString m_sAddress;  //家庭住址
	CString m_sPassword;		//密码
};

extern bankUser oneUser;
extern bankUser twoUser;
